...
class PerformanceCache:
    ...
    def flush(self, file_name, browser, is_test_passed):
        self.create_performance_entries(is_test_passed, browser)
    ...
    def create_performance_entries(self, is_test_passed, browser):
        ...
        for start_entry in rev_start_entries:
            ...
            if corresponded_end_entry:
                ...
                temp_performance_entry.br_name = "browserName" # todo find browser
    ...
    def write_performance_data_to_file(self, file_name: str) -> None:
        for performance_entry in self._performance_entries:
            FileWriter().append_line_to_file(file_name, f"{json.dumps(performance_entry.__dict__)}\n")
